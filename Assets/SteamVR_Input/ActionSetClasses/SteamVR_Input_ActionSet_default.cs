...
namespace Valve.VR
{
    ...
    public class SteamVR_Input_ActionSet_default : Valve.VR.SteamVR_ActionSet
    {
        ...
        public virtual SteamVR_Action_Vector2 MoveTest
        {
            get
            {
                return SteamVR_Actions.default_MoveTest;
            }
        }
        
        public virtual SteamVR_Action_Boolean MoveHeightUp
        {
            get
            {
                return SteamVR_Actions.default_MoveHeightUp;
            }
        }
        
        public virtual SteamVR_Action_Boolean MoveHeightDown
        {
            get
            {
                return SteamVR_Actions.default_MoveHeightDown;
            }
        }
        
        public virtual SteamVR_Action_Boolean Expand
        {
            get
            {
                return SteamVR_Actions.default_Expand;
            }
        }
        ...
        public virtual SteamVR_Action_Boolean Bright
        {
            get
            {
                return SteamVR_Actions.default_Bright;
            }
        }
